...
//keyboard
draw_set_colour(make_colour_rgb(38,50,56))
...
//stroke1
draw_rectangle_colour(0+1,round(mkb_sett[? 'h']-mkb_sett[? 'h']*(0.07+mkb_sett[? 'height'])+2),round(mkb_sett[? 'w']-1),round(mkb_sett[? 'h']-mkb_sett[? 'h']*(0.07)-1),make_colour_rgb(53,69,77),make_colour_rgb(53,69,77),make_colour_rgb(33,41,45),make_colour_rgb(33,41,45),1)

if !mkb_sett[? 'sug'] then exit;

//suggestions
draw_set_colour(make_colour_rgb(32,39,43))
...
//stroke2
draw_rectangle_colour(0,round(mkb_sett[? 'h']-mkb_sett[? 'h']*(0.07+mkb_sett[? 'height']+0.07)+1),round(mkb_sett[? 'w']),round(mkb_sett[? 'h']-mkb_sett[? 'h']*(0.07)),make_colour_rgb(69,86,94),make_colour_rgb(69,86,94),make_colour_rgb(30,36,40),make_colour_rgb(30,36,40),1)
