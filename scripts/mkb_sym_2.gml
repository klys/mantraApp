...
draw_set_alpha(1)
draw_letter(mkb_sett[? 'w']*0.05,yy,'~',1)
draw_letter(mkb_sett[? 'w']*0.15,yy,'`',1)
draw_letter(mkb_sett[? 'w']*0.25,yy,'|',1)
draw_letter(mkb_sett[? 'w']*0.35,yy,'•',1)
draw_letter(mkb_sett[? 'w']*0.45,yy,'√',1)
draw_letter(mkb_sett[? 'w']*0.55,yy,'π',1)
draw_letter(mkb_sett[? 'w']*0.65,yy,'÷',1)
draw_letter(mkb_sett[? 'w']*0.75,yy,'×',1)
draw_letter(mkb_sett[? 'w']*0.85,yy,'¶',1)
draw_letter(mkb_sett[? 'w']*0.95,yy,'Δ',1)
...
if draw_letter(mkb_sett[? 'w']*0.068,yy,'?123',3) then {mkb_sett[? 'symb']=1}
...
draw_letter(mkb_sett[? 'w']*0.3,yy,'<',4)
// SPACE
draw_set_alpha(0.12)
